package com.functiontest.project;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.bg_binder_test) {
            getSystemService(Context.ACTIVITY_SERVICE);
            Log.d("darren", "onOptionsItemSelected: -------------");
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.bg_binder_test:
            {
                fragment = fm.findFragmentByTag("bg binder test");
                if(fragment==null){
                    fragment = new BinderBgTestFragment();
                    fm.beginTransaction().add(fragment,"bg binder test");
                }
                setFragmentTitle("Bg binder call Test");
            }
            break;
            case R.id.mutilate_thread_arraymap:{
                fragment = fm.findFragmentByTag("mutilate thread arraymap");
                if(fragment==null){
                    fragment = new MutilateThreadArrayMapTestFragment();
    ...
    public void switchFragment(Fragment f) {
        ...
        transaction.replace(R.id.test_model_container,f);
        transaction.commit();
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
    }
